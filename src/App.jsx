...
const memberList = useMemo(() => {
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
             <h1>GM Fren🤝</h1>
      <p>welcome to the meeting point for frens of all backgrounds and interests</p>
        <div>
          <div>
            <h2>Member List</h2>
  ...
  return (
    <div className="mint-nft">
      <h1>Mint your 🤝FrenDAO Membership NFT</h1>
      <button
        disabled={isClaiming}
        onClick={() => mintNft()}
      >
        {isClaiming ? "Minting..." : "Mint your 🤝 (FREE)"}
      </button>
    </div>
  );
};
